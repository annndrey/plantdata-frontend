<template>
  <nav class="navbar navbar-expand-sm navbar-details">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
	<button type="button" class="btn widgetButton" :class="{ activeButton: activeItem == 'barchart'}" @click="setActive('barchart')">
	...
	<button type="button" class="btn widgetButton" :class="{ activeButton: activeItem == '3d'}" @click="setActive('3d')">
	  3d-view
      ...
      <li class="nav-item">
	<button type="button" class="btn widgetButton" :class="{ activeButton: activeItem == 'flag'}" @click="setActive('flag')">
