<template>
  <nav class="navbar navbar-expand-sm navbar-details">
	...
	<button type="button" class="btn btn-primary widgetButton" :class="{ activeButton: activeItem == '3d'}" @click="setActive('3d')">
      ...
      <li class="nav-item">
	<button type="button" disabled class="btn btn-primary widgetButton" :class="{ activeButton: activeItem == 'flag'}" @click="setActive('flag')">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
	<button type="button" disabled class="btn btn-primary widgetButton">
